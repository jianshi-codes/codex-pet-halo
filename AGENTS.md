...
- M8 — Release UI Polish — is implemented and in validation. It owns system appearance/accessibility polish, appearance-aware capsule contrast, visible-frame-safe label sides, Reduce Motion direct following, original application/menu icons, spacing, tests, smoke tooling, and documentation. It does not add a theme system or decorative effects.
