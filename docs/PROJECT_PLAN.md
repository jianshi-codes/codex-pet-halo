...
**Complete with partial gate — `PARTIAL — SOURCE RELEASE READY, SIGNED BINARY BLOCKED`.** PRs #10 and #11 merged on 2026-07-21. The repository is public, and `v0.1.0-beta.1` plus its unsigned Universal ZIP and checksum metadata were published on 2026-07-21. Compatibility hardening, onboarding, privacy/security/legal evidence, reproducible packaging, sanitized issue forms, and collision-safe future release automation are in place. Developer ID signing, Apple notarization, stapling, Gatekeeper verification, and signed clean-machine acceptance remain incomplete and require a new Beta identity. See [the M9 report](milestones/m9-public-beta-readiness.md).
